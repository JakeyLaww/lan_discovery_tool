...
int main() {
  ...
  ResourceRecordView rec_a{"Living Room._airplay._tcp.local", DnsType::SRV,
                           "0 0 7000 tv.local", 120, 1'700'000'000'000};
  ResourceRecordView rec_b{"Living Room._airplay._tcp.local", DnsType::TXT,
                           "txtvers=1", 120, 1'700'000'000'001};
  ...
  std::cout << std::endl
            << "✓ All device state store tests passed!" << std::endl;
  return 0;
}
